              ...
              <CardHeader className="pb-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <CardDescription className="text-xs">Send us an email anytime</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-3">
                <div>
                  <p className="text-xs text-muted-foreground mb-1.5">General Inquiries</p>
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      size="icon"
                      className="h-8 w-8"
                      onClick={() => copyToClipboard('support@stoq.com', 'support')}
                    >
                      {copiedEmail === 'support' ? (
                ...
                <div className="pt-2 border-t border-border">
                  <p className="text-xs text-muted-foreground mb-1.5">Business Inquiries</p>
                  <div className="flex items-center gap-2">
                    <a
                    ...
                    <Button
                      ...
                      size="icon"
                      className="h-8 w-8"
                      onClick={() => copyToClipboard('business@stoq.com', 'business')}
                    >
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <CardDescription className="text-xs">Speak with our team</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <CardDescription className="text-xs">Our office location</CardDescription>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-3">
                <div>
                  <p className="text-xs font-medium text-foreground mb-1.5">Address</p>
                ...
                <div className="pt-2 border-t border-border">
                  <p className="text-xs font-medium text-foreground mb-1.5">Business Hours</p>
                  <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <Card className={cn(
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <CardTitle className="text-lg mb-1">We're Here to Help</CardTitle>

      ...
      try {
        ...
        try {
          ...
          const isSessionError =
            signUpError.message?.includes("session") ||
        ...
        if (error?.message) {
          ...
          if (
            ...
            errorMsg.includes("try again after")
          ) {
            // Rate limiting - show appropriate message
            if (attemptCount >= 3) {
              errorMessage =
                "Too many signup attempts. Please wait 15-30 minutes before trying again.";
            } else {
              errorMessage =
          ...
          <div className="flex-1 overflow-y-auto min-h-0 px-6 scrollbar-thin">
            <Form {...form}>
              ...
              >
                ...
                {/* Navigation Buttons */}
                <div className="sticky bottom-0 bg-background border-t pt-4 pb-6 -mx-6 px-6 mt-6 z-10 rounded-b-lg">
                      ...
                      <Button
                        ...
                        onClick={async (e) => {
                          ...
                          if (!isValid) {
                            ...
                            const errors = form.formState.errors;
                            const step1AuthFields = [
                              "email",
                              "password",
                              "confirmPassword",
                            ] as const;
                            const step1PersonalFields = [
                              "firstName",
                              "lastName",
                              "phone",
                            ] as const;

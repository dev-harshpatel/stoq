              ...
              {items.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-4 text-sm text-foreground">{item.storage}</td>
                    <td className="px-4 py-4 text-center">
                      <span
                        className={cn(
                          'font-semibold',
            ...
            >
              <div className="flex items-start justify-between gap-3 mb-3">
                <div className="flex-1">
                  <h3 className="font-medium text-foreground">{item.deviceName}</h3>
                  <span className="flex items-center gap-1 text-xs text-muted-foreground mt-1">
                    <Clock className="h-3 w-3" />
                    Updated {item.lastUpdated}
                  </span>
              ...
              <div className="grid grid-cols-4 gap-3 text-sm">
                ...
                <div>
                  ...
                  <span className="font-medium text-foreground">{item.storage}</span>
                </div>
                <div>
                  <span className="text-xs text-muted-foreground block mb-1">Qty</span>
                  <span
                    className={cn(
                      'font-semibold',
                      status === 'critical' && 'text-destructive',
